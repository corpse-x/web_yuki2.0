...
if ENV:
    ...
    MESSAGE_DUMP = os.environ.get("MESSAGE_DUMP", "-1002221570986")
    DB_NAME = os.environ.get("DB_NAME", "TEST_YAE")
    ...
    SUPPORT_ID = int(os.environ.get("SUPPORT_ID", "-1002221570986"))  # Support group id
    SUPPORT_CHAT = os.environ.get("SUPPORT_CHAT", "yukilogs")
    TEMP_DOWNLOAD_DIRECTORY = os.environ.get("TEMP_DOWNLOAD_DIRECTORY", "./")
    TOKEN = os.environ.get("TOKEN", "5527818445:AAE7TLprBfyUuQvYZsaOesQ0F-9C2sl2I80")
...
ALIVE_MSG = """
*⟳ Sʏsᴛᴇᴍ Bᴏᴏᴛɪɴɢ Uᴘ... Pʟᴇᴀsᴇ Wᴀɪᴛ ᴀ Mᴏᴍᴇɴᴛ!* \n
*⟲ Hᴀᴠɪɴɢ ᴛʀᴏᴜʙʟᴇ? Cʜᴇᴄᴋ ᴛʜᴇ ʟᴏɢs ғᴏʀ ᴅᴇᴛᴀɪʟs* \n\n
☨ ᴘʏᴛʜᴏɴ ᴠᴇʀsɪᴏɴ ➥ `{y()}` \n
☨ ʟɪʙʀᴀʀʏ ᴠᴇʀsɪᴏɴ ➥ `{telever}` \n
☨ ᴛᴇʟᴇᴛʜᴏɴ ᴠᴇʀsɪᴏɴ ➥ `{tlhver}` \n
☨ ᴩʏʀᴏɢʀᴀᴍ ᴠᴇʀsɪᴏɴ ➥ `{pyrover}` \n
[‎ ](https://i.postimg.cc/cL6J14GF/booting-up.gif)
"""

ALIVE_IMG = [
    "CgACAgQAAx0CfWI6eQACLQlnTaQscj7Jx-J3x6CiFUz-HuBNDgAChAcAA85sUuoiUIoAAQcx1zYE",
]
# <=======================================================================================================>
...
async def send_booting_message():
    ...
    try:
        # Send the photo with the chosen file_id
        await bot.send_message(
            chat_id=SUPPORT_ID,
            text = f"""
*⟳ Sʏsᴛᴇᴍ Bᴏᴏᴛɪɴɢ Uᴘ... Pʟᴇᴀsᴇ Wᴀɪᴛ ᴀ Mᴏᴍᴇɴᴛ!* \n
*⟲ Hᴀᴠɪɴɢ ᴛʀᴏᴜʙʟᴇ? Cʜᴇᴄᴋ ᴛʜᴇ ʟᴏɢs ғᴏʀ ᴅᴇᴛᴀɪʟs* [‎ ](https://i.postimg.cc/cL6J14GF/booting-up.gif) \n
     [Pʏᴛʜᴏɴ](https://www.python.org/) ⋉ `{y()}`
     [Pᴛʙ](https://python-telegram-bot.org/)  ⋉ `{telever}`
     [Tᴇʟᴇᴛʜᴏɴ](https://docs.telethon.dev/en/stable/) ⋉ `{tlhver}`
     [Pʏʀᴏɢʀᴀᴍ](https://docs.pyrogram.org/) ⋉ `{pyrover}`""", parse_mode="Markdown"
                                )
